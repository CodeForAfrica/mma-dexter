...
"""
        ...
        self.assertEqual(doc.title, "IEC's Tlakula must resign: opposition parties")
        self.assertEqual(doc.summary, "Several opposition parties met in Pretoria on Tuesday to discuss Public Protector Thuli Madonsela's finding on the Nkandla upgrades and the controversy around IEC chairwoman Pansy Tlakula.")
