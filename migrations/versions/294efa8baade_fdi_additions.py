...
def upgrade():
    ...
    op.drop_constraint('investments_ibfk_9', 'investments', type_='foreignkey')
    op.drop_index('ix_investments_involvement_id', table_name='investments')
    op.drop_table('involvements')
    op.add_column('investments', sa.Column('gov_programs', sa.String(length=1024), nullable=True))
    op.add_column('investments', sa.Column('involvement_id1', sa.Integer(), nullable=True))
    op.add_column('investments', sa.Column('involvement_id2', sa.Integer(), nullable=True))
    op.add_column('investments', sa.Column('involvement_id3', sa.Integer(), nullable=True))
    op.add_column('investments', sa.Column('mot_investment', sa.String(length=1024), nullable=True))
    op.add_column('investments', sa.Column('phase_date', sa.Date(), nullable=True))
    op.add_column('investments', sa.Column('province_id', sa.Integer(), nullable=True))
    op.add_column('investments', sa.Column('soc_programs', sa.String(length=1024), nullable=True))
    op.add_column('investments', sa.Column('target_market', sa.String(length=50), nullable=True))
    ...
    op.drop_column('investments', 'involvement_id')
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.add_column('investments', sa.Column('involvement_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
    op.drop_constraint('investments_ibfk_12', 'investments', type_='foreignkey')
    op.drop_constraint('investments_ibfk_13', 'investments', type_='foreignkey')
    op.drop_constraint('investments_ibfk_14', 'investments', type_='foreignkey')
    op.drop_constraint('investments_ibfk_15', 'investments', type_='foreignkey')
    ...
    op.drop_column('investments', 'target_market')
    op.drop_column('investments', 'soc_programs')
    op.drop_column('investments', 'province_id')
    op.drop_column('investments', 'phase_date')
    op.drop_column('investments', 'mot_investment')
    op.drop_column('investments', 'involvement_id3')
    op.drop_column('investments', 'involvement_id2')
    op.drop_column('investments', 'involvement_id1')
    op.drop_column('investments', 'gov_programs')
    ...
    op.create_foreign_key('investments_ibfk_9', 'investments', 'involvements', ['involvement_id'], ['id'])
